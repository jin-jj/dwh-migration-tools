...
/** Dumps catalog definitions from the Unity Catalog REST API. */
class DatabricksRestCatalogsTask extends AbstractDatabricksRestTask implements CatalogsFormat {
  ...
  protected Void doRun(TaskRunContext context, @Nonnull ByteSink sink, @Nonnull Handle handle)
    ...
    logger.info("Writing catalogs from the REST API to '{}'", getTargetPath());
