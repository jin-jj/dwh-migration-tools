...
/** Dumps view definitions from the Unity Catalog REST API. */
class DatabricksRestViewsTask extends AbstractDatabricksRestTask implements ViewsFormat {
  ...
  protected Void doRun(TaskRunContext context, @Nonnull ByteSink sink, @Nonnull Handle handle)
    ...
    logger.info("Writing views from the REST API to '{}'", getTargetPath());
  ...
  private static boolean isView(TableType tableType) {
    return tableType == TableType.VIEW || tableType == TableType.MATERIALIZED_VIEW;
  }
}
