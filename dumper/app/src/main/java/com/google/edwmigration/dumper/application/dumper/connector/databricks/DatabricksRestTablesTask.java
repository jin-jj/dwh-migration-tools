...
/** Dumps table definitions from the Unity Catalog REST API. */
class DatabricksRestTablesTask extends AbstractDatabricksRestTask implements TablesFormat {

  private static final Logger logger = LoggerFactory.getLogger(DatabricksRestTablesTask.class);

  DatabricksRestTablesTask(@Nonnull DatabricksFilter filter) {
  ...
  protected Void doRun(TaskRunContext context, @Nonnull ByteSink sink, @Nonnull Handle handle)
    ...
    logger.info("Writing tables from the REST API to '{}'", getTargetPath());
